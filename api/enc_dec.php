...
<head>
    <meta charset="utf-8">
    <title>Welcome to DEX Application </title>

    <link rel="icon" href="localhost/dex/assets/images/logo.png" type="image/x-icon">
...
<div id="container">
    <h1>Encryption & Decryption Structure Application</h1>
...
$secret = hash('sha256', 'mcDDpbJnyDbuyiUKwrB3hUXNqNkaq8yA');  //must be 32 char length
$iv = 'mcDDpbJnyDbuyiUK';
